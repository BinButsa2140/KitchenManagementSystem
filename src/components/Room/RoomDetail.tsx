"use client";
import { findRoom } from "@/app/utils/room";
    ...
    <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-xl overflow-hidden p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div>
            <h2 className="font-semibold text-base sm:text-lg text-gray-800 mb-3">Description:</h2>
            <p className="text-gray-700 text-sm sm:text-base">{roomData.description}</p>
          </div>

          <div>
            <h2 className="font-semibold text-base sm:text-lg text-gray-800">Equipments</h2>
            <EquipmentsInRoom id={id} />
          </div>

          <div className="mt-6">
            <Link href={`/booking/${id}`} passHref>
              <button className="w-full sm:w-auto px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
                Book This Room
              </button>
            </Link>
          </div>
